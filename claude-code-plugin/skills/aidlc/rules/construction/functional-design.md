...
- **Claude Code Plugin Note**: For 1-3 simple clarifying questions, you may use the `AskUserQuestion` tool instead of creating a dedicated question file. For larger question sets, use the file-based approach.
